    ...
    <div class="min-h-screen flex" x-data="{ sidebarOpen: true }">
        ...
        <aside class="bg-gray-900 text-white transition-all duration-300 flex flex-col" 
            ...
            <nav class="flex-1 px-2 py-6 space-y-2">
                ...
                <a href="{{ route('admin.transactions.index') }}" class="flex items-center px-4 py-2 {{ request()->routeIs('admin.transactions.*') ? 'bg-gray-800 text-white' : 'text-gray-400 hover:bg-gray-800 hover:text-white' }} rounded-md transition">
