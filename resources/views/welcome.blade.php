    ...
    <nav class="bg-white border-b border-gray-200 fixed w-full top-0 z-[999] h-[68px] flex items-center shadow-sm">
        <div class="max-w-[1240px] mx-auto px-4 w-full flex justify-between items-center">
            ...
            <div class="flex items-center">
                <a href="/" class="mr-8">
                    <img src="https://images.seeklogo.com/logo-png/37/1/agoda-logo-png_seeklogo-371025.png" alt="Agoda" class="h-19 md:h-16 w-auto">
                </a>
            ...
            <div class="flex items-center space-x-3">
                ...
                @auth
                    ...
                    @if(Auth::user()->role === 'admin')
                        ...
                        <a href="{{ route('admin.dashboard') }}" class="text-[#0057b8] font-bold text-sm px-4 py-2 hover:bg-[#f3f8fd] border border-[#0057b8] rounded transition relative z-50 cursor-pointer">
                    ...
                    @else
                        ...
                        <div class="relative ml-3" x-data="{ open: false }">
                            <button @click="open = !open" type="button" class="flex items-center gap-2 focus:outline-none p-1 pr-2 rounded hover:bg-gray-100 transition border border-transparent hover:border-gray-200">
                                ...
                                <i class="fa-solid fa-chevron-down text-xs text-gray-500 transition-transform duration-200" :class="{'rotate-180': open}"></i>
                            </button>
...
<div class="max-w-[1240px] mx-auto px-4 py-12">
        ...
        <div class="flex overflow-x-auto space-x-5 pb-4 scrollbar-hide">
            <a href="#" class="flex-shrink-0 group">
                <div class="w-[220px] h-[220px] rounded-2xl overflow-hidden mb-3 shadow-md group-hover:shadow-xl transition-shadow">
                    <img src="https://images.unsplash.com/photo-1555891674-37c7737c7efb?w=400&h=400&fit=crop" alt="Jakarta" class="w-full h-full object-cover group-hover:scale-110 transition-transform duration-300">
                </div>
            ...
            <a href="#" class="flex-shrink-0 group">
                <div class="w-[220px] h-[220px] rounded-2xl overflow-hidden mb-3 shadow-md group-hover:shadow-xl transition-shadow">
                    <img src="https://images.unsplash.com/photo-1596422846543-75c6fc197f07?w=400&h=400&fit=crop" alt="Bandung" class="w-full h-full object-cover group-hover:scale-110 transition-transform duration-300">
                </div>
            ...
            <a href="#" class="flex-shrink-0 group">
                <div class="w-[220px] h-[220px] rounded-2xl overflow-hidden mb-3 shadow-md group-hover:shadow-xl transition-shadow">
                    <img src="https://images.unsplash.com/photo-1601815619928-a5ad8fea2e1d?w=400&h=400&fit=crop" alt="Yogyakarta" class="w-full h-full object-cover group-hover:scale-110 transition-transform duration-300">
                </div>
            ...
            <a href="#" class="flex-shrink-0 group">
                <div class="w-[220px] h-[220px] rounded-2xl overflow-hidden mb-3 shadow-md group-hover:shadow-xl transition-shadow">
                    <img src="https://images.unsplash.com/photo-1578916171728-46686eac8d58?w=400&h=400&fit=crop" alt="Surabaya" class="w-full h-full object-cover group-hover:scale-110 transition-transform duration-300">
                </div>
            ...
            <a href="#" class="flex-shrink-0 group">
                <div class="w-[220px] h-[220px] rounded-2xl overflow-hidden mb-3 shadow-md group-hover:shadow-xl transition-shadow">
                    <img src="https://images.unsplash.com/photo-1537953773345-d172ccf13cf1?w=400&h=400&fit=crop" alt="Bali" class="w-full h-full object-cover group-hover:scale-110 transition-transform duration-300">
                </div>
    ...
    <div class="max-w-[1240px] mx-auto px-4 py-12">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
            <div class="rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl transition-shadow cursor-pointer bg-gradient-to-br from-purple-600 to-purple-800">
            ...
            <div class="rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl transition-shadow cursor-pointer">
                <img src="https://images.unsplash.com/photo-1571896349842-33c89424de2d?w=600&h=400&fit=crop" alt="Promo Accor" class="w-full h-[280px] object-cover">
            </div>
            
            <div class="rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl transition-shadow cursor-pointer bg-gradient-to-br from-slate-800 to-slate-950">
    ...
    <div class="max-w-[1240px] mx-auto px-4 py-12">
        <h2 class="text-[28px] font-bold text-[#2a2a2e] mb-8">Liburan lebih irit pakai promo Penerbangan & Aktivitas ini!</h2>
        
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
            <div class="rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl transition-shadow cursor-pointer bg-gradient-to-r from-orange-500 to-orange-600">
            ...
            <div class="rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl transition-shadow cursor-pointer bg-gradient-to-br from-slate-900 to-blue-900">
                <img src="https://images.unsplash.com/photo-1613490493576-7fde63acd811?w=600&h=400&fit=crop" alt="Halloween Horror Nights" class="w-full h-[320px] object-cover">
            </div>
            
            <div class="rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl transition-shadow cursor-pointer bg-gradient-to-br from-purple-600 via-pink-500 to-purple-700">
                <div class="p-8 text-white flex flex-col justify-center h-[320px]">
                    <span class="bg-yellow-300 text-purple-800 text-xs font-black px-3 py-1 rounded-full inline-block mb-4 w-fit">FLASH SALE</span>
...
<div class="max-w-[1240px] mx-auto px-4 py-12">
        ...
        <div class="border-b border-gray-300 mb-6">
            <div class="flex space-x-8 overflow-x-auto scrollbar-hide">
                <button class="pb-4 border-b-4 border-[#0057b8] text-[#0057b8] font-bold text-[15px] whitespace-nowrap">Jakarta</button>
                <button class="pb-4 text-[#53535f] font-semibold text-[15px] hover:text-[#0057b8] whitespace-nowrap">Bandung</button>
                <button class="pb-4 text-[#53535f] font-semibold text-[15px] hover:text-[#0057b8] whitespace-nowrap">Yogyakarta</button>
                <button class="pb-4 text-[#53535f] font-semibold text-[15px] hover:text-[#0057b8] whitespace-nowrap">Surabaya</button>
                <button class="pb-4 text-[#53535f] font-semibold text-[15px] hover:text-[#0057b8] whitespace-nowrap">Bali</button>
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5">
            <a href="#" class="group">
                <div class="rounded-2xl overflow-hidden shadow-md group-hover:shadow-2xl transition-shadow relative">
                    <span class="absolute top-3 right-3 bg-[#0057b8] text-white px-3 py-1.5 rounded-lg font-bold text-sm z-10">9.1</span>
                    <img src="https://images.unsplash.com/photo-1566073771259-6a8506099945?w=600&h=400&fit=crop" alt="Hotel" class="w-full h-[220px] object-cover group-hover:scale-110 transition-transform duration-300">
                </div>
                <div class="mt-3">
                    ...
                    <p class="text-[13px] text-[#53535f] mb-1"><i class="fa-solid fa-location-dot text-[#0057b8] mr-1"></i> Pasar Baru, Jakarta</p>
            ...
            <a href="#" class="group">
                <div class="rounded-2xl overflow-hidden shadow-md group-hover:shadow-2xl transition-shadow relative">
                    <span class="absolute top-3 right-3 bg-[#0057b8] text-white px-3 py-1.5 rounded-lg font-bold text-sm z-10">8.9</span>
                    <img src="https://images.unsplash.com/photo-1562790351-d273a961e0e9?w=600&h=400&fit=crop" alt="Hotel" class="w-full h-[220px] object-cover group-hover:scale-110 transition-transform duration-300">
                </div>
                <div class="mt-3">
                    <h3 class="font-bold text-[16px] text-[#2a2a2e] mb-2">All Nite & Day Residence Kebon Jeruk Jakarta</h3>
                    <div class="flex items-center text-orange-500 text-sm mb-2">
                        <i class="fa-solid fa-star"></i>
                        <i class="fa-solid fa-star"></i>
                        <i class="fa-solid fa-star"></i>
                    ...
                    <p class="text-[13px] text-[#53535f] mb-1"><i class="fa-solid fa-location-dot text-[#0057b8] mr-1"></i> Kebon Jeruk, Jakarta</p>
                    <p class="text-[13px] text-[#53535f] mb-2">Per malam sebelum pajak dan biaya lainnya</p>
            ...
            <a href="#" class="group">
                <div class="rounded-2xl overflow-hidden shadow-md group-hover:shadow-2xl transition-shadow relative">
                    <span class="absolute top-3 right-3 bg-[#0057b8] text-white px-3 py-1.5 rounded-lg font-bold text-sm z-10">8.4</span>
                    <img src="https://images.unsplash.com/photo-1551882547-ff40c63fe5fa?w=600&h=400&fit=crop" alt="Hotel" class="w-full h-[220px] object-cover group-hover:scale-110 transition-transform duration-300">
                </div>
                <div class="mt-3">
                    ...
                    <p class="text-[13px] text-[#53535f] mb-1"><i class="fa-solid fa-location-dot text-[#0057b8] mr-1"></i> Mangga Besar, Jakarta</p>
                    <p class="text-[13px] text-[#53535f] mb-2">Per malam sebelum pajak dan biaya lainnya</p>
            ...
            <a href="#" class="group">
                <div class="rounded-2xl overflow-hidden shadow-md group-hover:shadow-2xl transition-shadow relative">
                    <span class="absolute top-3 right-3 bg-[#0057b8] text-white px-3 py-1.5 rounded-lg font-bold text-sm z-10">8.4</span>
                    <img src="https://images.unsplash.com/photo-1631049307264-da0ec9d70304?w=600&h=400&fit=crop" alt="Hotel" class="w-full h-[220px] object-cover group-hover:scale-110 transition-transform duration-300">
                </div>
                <div class="mt-3">
                    ...
                    <p class="text-[13px] text-[#53535f] mb-1"><i class="fa-solid fa-location-dot text-[#0057b8] mr-1"></i> Grogol, Jakarta</p>
                    <p class="text-[13px] text-[#53535f] mb-2">Per malam sebelum pajak dan biaya lainnya</p>
        ...
        <div class="text-center mt-8">
            <a href="#" class="text-[#0057b8] font-bold text-[15px] hover:underline flex items-center justify-center">
...
<div class="max-w-[1240px] mx-auto px-4 py-12">
        ...
        <div class="flex overflow-x-auto space-x-5 pb-4 scrollbar-hide">
            <a href="#" class="flex-shrink-0 group">
                <div class="w-[220px] h-[220px] rounded-2xl overflow-hidden mb-3 shadow-md group-hover:shadow-xl transition-shadow">
                    <img src="https://images.unsplash.com/photo-1596422846543-75c6fc197f07?w=400&h=400&fit=crop" alt="Kuala Lumpur" class="w-full h-full object-cover group-hover:scale-110 transition-transform duration-300">
                </div>
            ...
            <a href="#" class="flex-shrink-0 group">
                <div class="w-[220px] h-[220px] rounded-2xl overflow-hidden mb-3 shadow-md group-hover:shadow-xl transition-shadow">
                    <img src="https://images.unsplash.com/photo-1540959733332-eab4deabeeaf?w=400&h=400&fit=crop" alt="Tokyo" class="w-full h-full object-cover group-hover:scale-110 transition-transform duration-300">
                </div>
            ...
            <a href="#" class="flex-shrink-0 group">
                <div class="w-[220px] h-[220px] rounded-2xl overflow-hidden mb-3 shadow-md group-hover:shadow-xl transition-shadow">
                    <img src="https://images.unsplash.com/photo-1564500299591-e9c880d726f4?w=400&h=400&fit=crop" alt="Taichung" class="w-full h-full object-cover group-hover:scale-110 transition-transform duration-300">
                </div>
            ...
            <a href="#" class="flex-shrink-0 group">
                <div class="w-[220px] h-[220px] rounded-2xl overflow-hidden mb-3 shadow-md group-hover:shadow-xl transition-shadow">
                    <img src="https://images.unsplash.com/photo-1524413840807-0c3cb6fa808d?w=400&h=400&fit=crop" alt="Taipei" class="w-full h-full object-cover group-hover:scale-110 transition-transform duration-300">
                </div>
            ...
            <a href="#" class="flex-shrink-0 group">
                <div class="w-[220px] h-[220px] rounded-2xl overflow-hidden mb-3 shadow-md group-hover:shadow-xl transition-shadow">
                    <img src="https://images.unsplash.com/photo-1598971457999-ca8e5dfaf5e8?w=400&h=400&fit=crop" alt="Johor Bahru" class="w-full h-full object-cover group-hover:scale-110 transition-transform duration-300">
                </div>
        ...
        <div class="max-w-[1240px] mx-auto px-4 py-12">
            <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-8 mb-12">
                <div>
                    ...
                    <ul class="space-y-3">
                        <li><a href="#" class="text-[14px] text-[#53535f] hover:text-[#0057b8]">Pusat bantuan</a></li>
                        <li><a href="#" class="text-[14px] text-[#53535f] hover:text-[#0057b8]">FAQ</a></li>
                        <li><a href="#" class="text-[14px] text-[#53535f] hover:text-[#0057b8]">Kebijakan privasi</a></li>
                        <li><a href="#" class="text-[14px] text-[#53535f] hover:text-[#0057b8]">Kebijakan cookie</a></li>
                        <li><a href="#" class="text-[14px] text-[#53535f] hover:text-[#0057b8]">Ketentuan penggunaan</a></li>
                        <li><a href="#" class="text-[14px] text-[#53535f] hover:text-[#0057b8]">Kelola preferensi cookie</a></li>
                        <li><a href="#" class="text-[14px] text-[#53535f] hover:text-[#0057b8]">Undang-Undang Layanan Digital (DSA) Uni Eropa</a></li>
                        <li><a href="#" class="text-[14px] text-[#53535f] hover:text-[#0057b8]">Pedoman konten & pelaporan</a></li>
                        <li><a href="#" class="text-[14px] text-[#53535f] hover:text-[#0057b8]">Pernyataan Perbudakan Modern</a></li>
                    </ul>
                </div>
                ...
                <div>
                    ...
                    <ul class="space-y-3">
                        <li><a href="#" class="text-[14px] text-[#53535f] hover:text-[#0057b8]">Tentang kami</a></li>
                        ...
                        <li><a href="#" class="text-[14px] text-[#53535f] hover:text-[#0057b8]">PointsMAX</a></li>
                    </ul>
                </div>
                ...
                <div>
                    ...
                    <ul class="space-y-3">
                        ...
                        <li><a href="#" class="text-[14px] text-[#53535f] hover:text-[#0057b8]">Semua Rute Penerbangan</a></li>
                    </ul>
                </div>
                ...
                <div>
                    ...
                    <ul class="space-y-3">
                        <li><a href="#" class="text-[14px] text-[#53535f] hover:text-[#0057b8]">Portal partner YCS</a></li>
                        <li><a href="#" class="text-[14px] text-[#53535f] hover:text-[#0057b8]">Partner Hub</a></li>
                        <li><a href="#" class="text-[14px] text-[#53535f] hover:text-[#0057b8]">Beriklan di Agoda</a></li>
                        <li><a href="#" class="text-[14px] text-[#53535f] hover:text-[#0057b8]">Afiliasi</a></li>
                        <li><a href="#" class="text-[14px] text-[#53535f] hover:text-[#0057b8]">Dokumentasi API Agoda</a></li>
                    </ul>
                </div>
                ...
                <div>
                    ...
                    <ul class="space-y-3">
                        <li><a href="#" class="text-[14px] text-[#53535f] hover:text-[#0057b8]">Aplikasi iOS</a></li>
                        <li><a href="#" class="text-[14px] text-[#53535f] hover:text-[#0057b8]">Aplikasi Android</a></li>
                    </ul>
                </div>
            </div>
            ...
            <div class="border-t border-gray-300 pt-8">
                ...
                <p class="text-[13px] text-[#53535f] text-center mb-8">
                    Agoda adalah bagian dari Booking Holdings Inc., pemimpin bisnis perjalanan online dan layanan terkait lainnya di dunia.
                </p>
                
                <div class="flex justify-center items-center space-x-8 flex-wrap gap-4">
                    <img src="https://logos-world.net/wp-content/uploads/2021/03/Agoda-Logo.png" alt="Agoda" class="h-8 opacity-60 hover:opacity-100 transition">
                    <img src="https://logos-world.net/wp-content/uploads/2020/04/Priceline-Logo.png" alt="Priceline" class="h-8 opacity-60 hover:opacity-100 transition">
                    <img src="https://logos-world.net/wp-content/uploads/2020/04/Kayak-Logo.png" alt="Kayak" class="h-8 opacity-60 hover:opacity-100 transition">
                    <img src="https://logos-world.net/wp-content/uploads/2020/04/Booking-com-Logo.png" alt="Booking.com" class="h-8 opacity-60 hover:opacity-100 transition">
                    <img src="https://logos-world.net/wp-content/uploads/2021/03/OpenTable-Logo.png" alt="OpenTable" class="h-8 opacity-60 hover:opacity-100 transition">
                </div>
            </div>
        </div>
    </footer>
